...
import { removeFromCart , addToCart, minusFromCart } from "../../Redux/Actions/index";
           ...
           <TableHead>
            ...
            {cartItems.map((item) => {
             ...
             <CheckTd>
              ...
              <CountsTd>
              <button onClick={()=> handleMinimum(cartItems,item)}><MinusIcon ></MinusIcon></button>
                <div>{item.count}</div>
                <button onClick={()=>addToCart(cartItems,item)}><PlusIcon ></PlusIcon></button>
...
export default connect( mapStateToProps, { addToCart, removeFromCart, minusFromCart })(OrderList);
